Public Class Form1
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        '    Or TextBox5.Text = "" Or TextBox6.Text = "" Or TextBox7.Text = "" _
        '    Or TextBox8.Text = "" Or TextBox9.Text = "" Then
        '    MessageBox.Show("Имате празно поле!")
        'End If
        ...
        If 0 >= N1 Or 0 >= N2 Or 0 >= N3 Or 0 >= N4 Or 0 >= N5 Or 0 >= N6 Or 0 >= N7 Or 0 >= N8 Or 0 >= N9 _
            ...
            MessageBox.Show("Моля, попълнете всички полета с числа от 1 до 9!")
            'TextBox10.Text = ""
            'TextBox11.Text = ""
            'TextBox12.Text = ""
            'TextBox13.Text = ""
        ...
        If N1 = N2 Or N1 = N3 Or N1 = N4 Or N1 = N5 Or N1 = N6 Or N1 = N7 Or N1 = N8 Or N1 = N9 _
            ...
            Or N8 = N9 Then
            'Else
            '    N1 = 0 Or N2 = 0 Or N3 = 0 Or N4 = 0 Or N5 = 0 Or N6 = 0 Or N7 = 0 Or N8 = 0 Or N9 = 0
            MessageBox.Show("Имате попълнени повтарящи се полета!")
            'TextBox10.Text = ""
            'TextBox11.Text = ""
            'TextBox12.Text = ""
            'TextBox13.Text = ""
